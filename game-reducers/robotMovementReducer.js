 ...
 * functions
 **/
export default function robotMovementReducer( oldState, time ) {
    // Merge the old state with the updated properties
    return {
        ...oldState,
        monkeyPosition: new Vector3( 0, 0, positionScale * Math.sin( time * positionSpeed ) + positionOffset ),
        monkeyRotation: new Euler( 0, 0, rotationScale * Math.sin( time * rotationSpeed ) )
    };
